...
{                                   // **Vec** stores vectors of floating point numbers.  Puts vector math into JavaScript.
  ...
  dist       (b) { return Math.sqrt(Math.pow(this[0] - b[0], 2) + Math.pow(this[1] - b[1], 2) + Math.pow(this[2] - b[2], 2) ) }
  mag         () { return Math.sqrt(Math.pow(this[0], 2) + Math.pow(this[1], 2) + Math.pow(this[2], 2) ) }
  limit      (s) { return this.mag() > s ? this.normalized().times(s) : this }
